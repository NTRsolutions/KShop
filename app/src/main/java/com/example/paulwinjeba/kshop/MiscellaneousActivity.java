...
public class MiscellaneousActivity extends AppCompatActivity
            ...
            protected void populateViewHolder(MiscellaneousActivity.BlogViewHolder viewHolder, Blog model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent singleBlogIntent = new Intent(MiscellaneousActivity.this,BlogSingleActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.electronics) {
            ...
            final Intent electronic = new Intent(MiscellaneousActivity.this,ClothesActivity.class);
            startActivity(electronic);

        } else if (id == R.id.bike) {
            final Intent electronic = new Intent(MiscellaneousActivity.this,BikesActivity.class);
            startActivity(electronic);

        } else if (id == R.id.book) {
            final Intent electronic = new Intent(MiscellaneousActivity.this,BooksActivity.class);
            startActivity(electronic);
            ...
            final Intent upload = new Intent(MiscellaneousActivity.this,MyPostActivity.class);
            startActivity(upload);

        } else if (id == R.id.upload) {
            if (mAuth.getCurrentUser() != null) {
                // User is logged in
                final Intent upload = new Intent(MiscellaneousActivity.this,PostActivity.class);
                startActivity(upload);
            }
            else
            {
