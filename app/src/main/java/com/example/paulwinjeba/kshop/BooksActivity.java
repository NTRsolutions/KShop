...
public class BooksActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        /*if(id == R.id.searches){
            ...
            if (mAuth.getCurrentUser() != null) {
                Intent request = new Intent(BooksActivity.this, MyRequestActivity.class);
                startActivity(request);
            }
            else
                Toast.makeText(BooksActivity.this, "Log in to view your request... !", Toast.LENGTH_LONG).show();
