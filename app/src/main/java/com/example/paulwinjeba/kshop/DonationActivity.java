...
public class DonationActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post = (RecyclerView) findViewById(R.id.donation_view);
    ...
    protected void onStart(){
        super.onStart();
        FirebaseRecyclerAdapter<Blog, DonationActivity.BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Blog, DonationActivity.BlogViewHolder>(
                Blog.class,
                R.layout.post_row,
                DonationActivity.BlogViewHolder.class,
                databaseReference
        ) {
            @Override
            protected void populateViewHolder(DonationActivity.BlogViewHolder viewHolder, Blog model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent singleBlogIntent = new Intent(DonationActivity.this,BlogSingleActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(id == R.id.searches){
            ...
            final Intent electronic = new Intent(DonationActivity.this, ClothesActivity.class);
            startActivity(electronic);

        } else if (id == R.id.bike) {
            final Intent electronic = new Intent(DonationActivity.this, BikesActivity.class);
            startActivity(electronic);

        } else if (id == R.id.book) {
            final Intent electronic = new Intent(DonationActivity.this, BooksActivity.class);
            startActivity(electronic);

        } else if (id == R.id.miscellaneous) {
            final Intent electronic = new Intent(DonationActivity.this, MiscellaneousActivity.class);
            startActivity(electronic);
            ...
            if (mAuth.getCurrentUser() != null) {
                // User is logged in
                final Intent upload = new Intent(DonationActivity.this, PostActivity.class);
                ...
                try {
                    ...
                    AlertDialog.Builder alert = new AlertDialog.Builder(DonationActivity.this);
                    //Set the button id
                    ...
                    login.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent nxtlogin = new Intent(DonationActivity.this, PostLoginActivity.class);
                            key = 0;
                    ...
                    signin.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            final Intent nxtsignin = new Intent(DonationActivity.this, PostSigninActivity.class);
                            key = 0;
            ...
            if (mAuth.getCurrentUser() != null) {
                // User is logged in
                final Intent upload = new Intent(DonationActivity.this, DonateActivity.class);
                startActivity(upload);
            } else {
                try {
                    LayoutInflater inflater = getLayoutInflater();
            ...
            if (mAuth.getCurrentUser() != null) {
                final Intent profile = new Intent(DonationActivity.this, MyProfileActivity.class);
                String UUid = mAuth.getCurrentUser().getUid().toString();
                profile.putExtra("uuid", UUid);
                startActivity(profile);
            } else {
                Toast.makeText(DonationActivity.this,"Log in to check your profile !",Toast.LENGTH_LONG).show();
            }
        } else if (id == R.id.mypost) {
            if (mAuth.getCurrentUser() != null) {
                final Intent mypost = new Intent(DonationActivity.this, MyPostActivity.class);

                startActivity(mypost);
            } else {
                Toast.makeText(DonationActivity.this,"Log in to check your posts !",Toast.LENGTH_LONG).show();
            }
        } else if (id == R.id.about){
            final Intent about = new Intent(DonationActivity.this, AboutActivity.class);
            startActivity(about);
        }
            ...
            if(mAuth.getCurrentUser() != null){
                ...
                Intent homeagain = new Intent(DonationActivity.this, FirstpageActivity.class);
                homeagain.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                Toast.makeText(DonationActivity.this,"Logged Out Successfully",Toast.LENGTH_LONG).show();
